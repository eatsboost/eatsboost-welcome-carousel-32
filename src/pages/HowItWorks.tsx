          ...
          >
            <div className="relative pl-16 md:pl-20">
              ...
              <div>
                ...
                <p className="text-black text-lg">Each eatery has an <span className="font-bold">exclusive</span> Boost Card available for purchase. Buy your very own for <span className="font-bold">$10</span>. The Boost Card is a one time purchase, and gives you <span className="font-bold">lifelong</span> offers!</p>
